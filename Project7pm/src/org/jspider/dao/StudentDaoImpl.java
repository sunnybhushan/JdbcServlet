...
public class StudentDaoImpl implements StudentDaoInterface
{
	...
	//count will be fetched from the database//
	
	Statement statement=connection.createStatement();
	ResultSet rs=statment.executeQu
	...
	public int updateStudent(String student) throws Exception 
	{
		...
		PreparedStatement prepareStatement=connection.prepareStatement("update table_student set first_name=?");
